...
def get_models():
    ...
    models = [ChatGroq(model=m, temperature=0.3, groq_api_key=GROQ_API_KEY) for m in main_models]
    routers = [ChatGroq(model=r, temperature=0.0, groq_api_key=GROQ_API_KEY) for r in router_models]
