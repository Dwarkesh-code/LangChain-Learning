...
class Summary(TypedDict):
    key_theme : Annotated[list[str],"Write down all the key themes that discused in the review"]
    summary : Annotated[str,"A brief summary of this review"] 
    sentiment : Literal["Positive", "Negative", "Neutral"]
    pros : Annotated[Optional[list[str]],"write down all pros of this review"]
    cons : Annotated[Optional[list[str]],"write down all cons of this review"]
    name : Annotated[Optional[str],"Return the full name of the person who wrote this review. Only return a proper human name. If no human name is mentioned, return 'NoName'"]
